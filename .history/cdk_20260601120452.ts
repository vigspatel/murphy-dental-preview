...
StaticSiteStack.fromConfig(app, {
    ...
    preview: {
        ...
        lambdas: {
            contact: {
                environment: {
                    CONTACT_EMAIL_TO: 'all@moderndocmedia.com',
                    CONTACT_EMAIL_FROM: 'contact@moderndocmedia.com',
                },
            },
        },
    },
    live: {
        ...
        lambdas: {
            contact: {
                environment: {
                    CONTACT_EMAIL_TO: 'mdcgroup@murphydentalcenter.com',
                    CONTACT_EMAIL_FROM: 'contact@murphydentalcenter.com',
                },
            },
        },
    },

...
const PrivacyPolicy: Page = () => (
    <Fragment>
        ...
        <Article>
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        to Murphy Dental Center, {info.address.text}.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Murphy Dental Center, accessible from{' '}
                        <CLink to="/" rel="external nofollow noopener noreferrer" target="_blank">
                            https://www.murphydentalcenter.com/
                        </CLink>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    By email: <CLink to={info.email.link}>{info.email.text}</CLink>
                </li>
                <li>
                    <p>
                        By visiting this page on our website:{' '}
                        <CLink
                            to={getNavLink('contact us')}
                            rel="external nofollow noopener noreferrer"
                            target="_blank"
                        >
                            https://www.murphydentalcenter.com/contact-us/
                        </CLink>
                    </p>
                </li>
                <li>
                    By phone: <CLink to={info.phone.link}>{info.phone.text}</CLink>
                </li>
            </ul>
        </Article>
    </Fragment>

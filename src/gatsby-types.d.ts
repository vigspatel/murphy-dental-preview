...
type FileFieldsEnum =
  ...
  | 'childMdx.excerpt'
  | 'childMdx.fields.collection'
  | 'childMdx.fields.slug'
  | 'childMdx.frontmatter.customTitle'
  ...
  | 'childrenMdx.excerpt'
  | 'childrenMdx.fields.collection'
  | 'childrenMdx.fields.slug'
  | 'childrenMdx.frontmatter.customTitle'
...
type MdxFrontmatter = {
  readonly customTitle: Maybe<Scalars['String']>;
  readonly description: Scalars['String'];
  readonly image: File;
};

type MdxFrontmatterFilterInput = {
  readonly customTitle: InputMaybe<StringQueryOperatorInput>;
  readonly description: InputMaybe<StringQueryOperatorInput>;
...
type homepageHeroBgQueryVariables = Exact<{ [key: string]: never; }>;


type homepageHeroBgQuery = { readonly mobile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly desktop: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly dummy: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null };

type servicePagesQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type servicePagesQuery = { readonly mdx: { readonly frontmatter: { readonly description: string, readonly customTitle: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } } } | null };

type mdxPagesGenerationQueryVariables = Exact<{ [key: string]: never; }>;


type mdxPagesGenerationQuery = { readonly services: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly internal: { readonly contentFilePath: string | null } }> } };
